...
from db.main import login,get_all_employee_details,get_employee_details
...
"font: 16pt \"Sans Serif\";")
        ...
        self.frame_42 = QtWidgets.QFrame(self.frame_9)
        ...
        self.back_btn_login = QtWidgets.QPushButton(self.frame_42)
        self.back_btn_login.setMinimumSize(QtCore.QSize(100, 50))
        self.back_btn_login.setStyleSheet("font:16pt;")
        self.back_btn_login.setIcon(icon)
        self.back_btn_login.setIconSize(QtCore.QSize(20, 20))
        self.back_btn_login.setObjectName("back_btn_login")
        self.verticalLayout_34.addWidget(self.back_btn_login)
        self.verticalLayout_33.addWidget(self.frame_42, 0, QtCore.Qt.AlignRight|QtCore.Qt.AlignTop)
...
"font: 16pt \"Sans Serif\";")
        ...
        self.verticalLayout_33.addWidget(self.frame_10, 0, QtCore.Qt.AlignVCenter)
...
"padding : 10px 20px;")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("../../../../../mnt/c/Users/prasa/Downloads/delete.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"padding:10px 20px")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("../../../../../mnt/c/Users/prasa/Downloads/update.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"padding:10px 20px")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.back_btn_login.setText(_translate("MainWindow", "Back"))
        ...
        self.back_btn_login.clicked.connect(lambda: self.stackedWidget.setCurrentWidget(self.rms_main))
        ...
        self.pushButton_4.clicked.connect(self.on_login)
    ...
    def on_login(self):
        ...
        if(result):
                ...
                self.pushButton_4.setText("Click here for dashboard access.")
                self.pushButton_4.clicked.connect(lambda: self.stackedWidget.setCurrentWidget(self.rms_dashboard))
                ...
                self.role=role
                self.gender=gender
                self.label_14.setText(str(self.username).title())
                self.label_15.setText(str(self.age))
                self.label_16.setText(str(self.gender).title())
                self.label_17.setText(str(self.email))
                self.label_18.setText(str(self.role).title())
